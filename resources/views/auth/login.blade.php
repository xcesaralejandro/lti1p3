...
<div class="row py-5 p-4">
  <div class="col-md-6 offset-md-3 col-xl-4 offset-xl-4">
    <div class="p-3 border  pb-3 bg-white">
      <div class="login-logo-container">
        <img width="100%" src="{{ asset('img/lti1p3-logo-dark.png') }}" />
      </div>
      <h3 class="pt-2 pb-2">
    ...
    <div class="mt-2 text-center">
      <a href="https://cesarmora.cl" class="link-underline-light">© César Alejandro Mora Cid</a>
    </div>
  </div>
</div>
@endsection